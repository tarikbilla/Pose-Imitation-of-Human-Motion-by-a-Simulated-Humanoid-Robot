...
Source for the laboratory column: `docs/PRD.md` on the `main` branch of this
repository, sections 5.1 (capture hardware), 7 NFR-7 (portability), 8
(tooling) and 11 (the CUDA requirement). This branch carries only the A3
work, so the PRD is not checked out alongside it.
